...
The minimum primbix with value 18 is above 5 700 000 000 000 and below or equal to 12 279 094 871 663 (which has primbix value 18).
...
[5 700 000 000 000, 5 800 000 000 000): <--- 1 CPU
...
[6 700 000 000 000, 6 800 000 000 000): <--- 1 CPU
...
[7 700 000 000 000, 7 800 000 000 000): <--- 1 CPU
...
[8 700 000 000 000, 8 800 000 000 000): <--- 1 CPU
...
[9 700 000 000 000, 9 800 000 000 000): <--- 1 CPU
...
[10 600 000 000 000, 10 700 000 000 000): <--- 1 CPU
```
