...
The minimum primbix with value 18 is above 11 100 000 000 000 and below or equal to 12 279 094 871 663 (which has primbix value 18).
...
[11 100 000 000 000, 11 200 000 000 000): <--- 1 CPU
...
[13 100 000 000 000, 13 200 000 000 000): <--- 1 CPU

[14 000 000 000 000, 14 100 000 000 000): 16, 14 036 967 290 399
[14 100 000 000 000, 14 200 000 000 000): <--- 1 CPU
```
